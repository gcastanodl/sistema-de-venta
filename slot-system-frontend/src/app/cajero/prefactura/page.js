...
function PrefacturaPage() {
  ...
  const { items, orden, negocio, total, fecha, descuento } = factura;
  ...
  return (
    <div style={{ fontFamily: "'Courier New', monospace", width: "72mm", margin: "0 auto", padding: "4mm 3mm", background: "white", color: "black", fontSize: "13px", lineHeight: "1.5" }}>
      ...
      <div style={{ textAlign: "center", margin: "6px 0" }}>
        <div style={{ fontSize: "15px", fontWeight: "bold", letterSpacing: "3px" }}>PRE-FACTURA</div>
      ...
      <div className="dashed" />
      <div style={{ textAlign: "center", fontSize: "10px", margin: "4px 0 2px 0", fontWeight: "bold" }}>*** PRE-FACTURA — NO ES FACTURA FINAL ***</div>
      <div style={{ textAlign: "center", fontSize: "12px" }}>Gracias por su visita</div>
...
export default function PrefacturaPageWrapper() {
  return (
